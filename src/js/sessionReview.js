...
(function () {
    ...
    class SessionReview {
        ...
        async refresh() {
            ...
            if (!tauriInvoke) {
                console.error('SessionReview: cannot refresh without Tauri invoke');
                return;
            }
            ...
            try {
                ...
                this.entries = await tauriInvoke('list_session_entries', { startTimeIso });
        ...
        updateSummary() {
            ...
            const distractionCount = this.entries.filter(
                (e) =>
