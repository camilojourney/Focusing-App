...
2. State records the phase, goal, timer remainders, session settings, check-in counters, and focus-shield state. It is atomically replaced only after serialization and version validation succeed.
